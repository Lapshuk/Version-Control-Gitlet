...
public class CommitTree implements Serializable {
    ...
    public void merge(String givenBranch, Stage s) {
        ...
        if (checkIsAncestor(givenBranch, givenCommit)) {
            return;
        }
        if (checkIsFF(givenBranch, givenCommit)) {
            return;
        }
    ...
    /**
     * Check if the current branch is the splitPoint
     *
     * @param givenBranch, givenCommit
     */
    public boolean checkIsFF(String givenBranch, Commit givenCommit) {
        Commit splitPoint = getCurrentBranchCommit().findSplitPoint(givenCommit);
        //if the split point is same as current ==> do nothing
    ...
    /**
     * Check if the given branch is the ancestor of the current branch
     *
     * @param givenBranch, givenCommit
     */
    public boolean checkIsAncestor(String givenBranch, Commit givenCommit) {
        Commit splitPoint = getCurrentBranchCommit().findSplitPoint(givenCommit);
